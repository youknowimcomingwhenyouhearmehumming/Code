...
os.chdir('C:/Users/Bruger/Documents/Uni/Advanche machine learning/Projekt/Code/Rasmus')

reduced_dim_chosen_95PCA = np.load('reduced_dim_chosen_95PCA.npy')
#######################################################################
...
#For binary
#"""
#X_train=reduced_dim_chosen_95PCA[train_indicies]
#y_train=full_isAnimal_array[train_indicies]
#
#X_test=reduced_dim_chosen_95PCA[test_indicies]
...
clf.export('TPOT_EXPORT_autoML_newData_CHANNELSREMOVED_95PCA_6_Label.py.py')
